...
def generate_index(csv_filepath):
    ...
    i = 0
    for item in data:
        if item['symbol_id'] not in symbol_id2index and is_valid_symbol(item['symbol_id']):
            symbol_id2index[item['symbol_id']] = i
            symbol_id2latex[item['symbol_id']] = item['latex']
            i += 1

    return symbol_id2index, symbol_id2latex
